...
final captureServiceProvider = FutureProvider<CaptureService>((ref) async {
  ...
  final indexCoordinator = await ref.watch(
    searchIndexCoordinatorProvider.future,
  );
  final extractionPipeline = ref.watch(contentExtractionPipelineProvider);
