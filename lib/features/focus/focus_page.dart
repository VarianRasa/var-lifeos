      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final padding = constraints.maxWidth <= 320 ? 16.0 : 24.0;
            return SingleChildScrollView(
              padding: EdgeInsets.all(padding),
              child: Center(
                child: ConstrainedBox(
                  constraints: BoxConstraints(maxWidth: compact ? 560 : 1120),
                  child: compact
                      ? Column(
                          key: const ValueKey('focus-compact-column'),
                          children: [
                            DailyFocusStatsCard(
                              completedSessions:
                                  timerState.completedSessionsCount,
                      ...
                      : Row(
                          key: const ValueKey('focus-expanded-row'),
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Expanded(
                              child: Column(
